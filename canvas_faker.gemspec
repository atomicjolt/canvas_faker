...
Gem::Specification.new do |spec|
  ...
  spec.authors       = ["Justin Ball"]
  spec.email         = ["justin.ball@atomicjolt.com"]

  spec.summary       = "Utility for setting up courses and users in Instructure Canvas."
  spec.description   = "Atomic Jolt found that we frequently needed to setup courses with users to test. This gem handles that requirement."
